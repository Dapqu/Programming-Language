    ...
    private static Stream<Arguments> testFunctionExpression() {
        ...
        return Stream.of(
                ...
                Arguments.of("Zero Arguments",
                        // function()
                        init(new Ast.Expression.Function("function", Arrays.asList()), ast -> ast.setFunction(new Environment.Function("function", "function", Arrays.asList(), Environment.Type.NIL, args -> Environment.NIL))),
                        "function()"
                )
        );
    }
